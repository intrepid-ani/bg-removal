...
export const testimonialsData = [
  ...
  {
    id: 3,
    text: "As a graphic designer, this tool has saved me countless hours. The AI-powered background removal is seamless and precise.",
  ...
  {
    id: 4,
    text: "Super easy to use! I use it for e-commerce product images, and it works flawlessly every time.",
